...
- **Folios configurables** (Ajustes › Folios): el prefijo de cada documento lo elige el negocio (hasta 4 letras o números, o ninguno), o una sola numeración corrida para todo. El contador va por documento y por sucursal, así que cambiar la letra no reinicia la cuenta.
