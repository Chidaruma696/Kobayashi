...
- **Resumen del día**: al cerrar el corte sale una hoja de 80 mm con lo que pasó por la caja (ventas por forma de pago, cambio, abonos, devoluciones, retiros, fondo, esperado, contado, diferencia y desglose), lo más vendido, las mermas de producción, lo que quedó por revisar y los cargos; se imprime o se comparte (Web Share o al portapapeles). Queda en la lista de cortes y se puede ver a medio día. Cierra #31.
