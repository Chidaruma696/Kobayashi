class Rol < ApplicationRecord
  ...
  BASE = {
    ...
    "supervisor" => [ "caja.*", "inventario.*", "compras.*", "retornables.*", "almacenes.*", "etiquetas.*", "pedidos.*", "produccion.*", "salidas.*", "rutas.*", "cobranza.*", "canastillas.*", "conteos.*", "reportes.ver", "revisiones.resolver" ]
  }.freeze
